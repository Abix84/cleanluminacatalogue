...
-- ==========================================
-- 7. FONCTIONS UTILITAIRES POUR LES RÔLES
-- ==========================================
...
DROP POLICY IF EXISTS "Les utilisateurs authentifiés peuvent lire les informations de contact" ON contact_info;
CREATE POLICY "Les utilisateurs authentifiés peuvent lire les informations de contact"
ON contact_info FOR SELECT
TO authenticated
USING (true);

DROP POLICY IF EXISTS "Seuls les admins peuvent modifier les informations de contact" ON contact_info;
