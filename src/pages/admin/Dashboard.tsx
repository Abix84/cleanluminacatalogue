  ...
  return (
    <>
      <div className="flex items-center">
        <h1 className="text-lg font-semibold md:text-2xl">Produits</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gérez vos produits ici. Ajoutez, modifiez ou supprimez des produits.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
